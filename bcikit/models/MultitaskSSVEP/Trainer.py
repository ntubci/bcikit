...
class Multitask_Trainer(object):
    ...
    def __init__(self, model, model_name='model', optimizer=None, criterion=None, scheduler=None, learning_rate=0.001, device='cpu', num_classes=4, multitask_learning=True, patience=10, verbose=False, print_training_metric=False, warmup_lr=False, **kwargs):
        ...
        if optimizer:
            ...
            # self.optimizer = optim.AdamW(params_to_update, lr=learning_rate, weight_decay=0.05)
...
#             print('\t', len(params_to_update), 'layers')
    ...
    def fit(self, dataloaders_dict, num_epochs=10, early_stopping=5, topk_accuracy=1, min_num_epoch=10, early_stop_lr=1e-8, save_model=False):
        if self.verbose:
            print("-------")
        ...
        for epoch in range(num_epochs):
            ...
            if early_stopping and epoch > min_num_epoch:
                ...
                if current_lr <= early_stop_lr:
                    print("LR too small, ended early")
                    break
            ...
            if self.multitask_learning:
                ...
                for i in range(self.num_classes):
                    ...
                    try:
                        ...
                        print(1,output.shape, output)
                        print(2,label.shape, label)
                        print(555, labels)
                        print(3,output.size(0))
